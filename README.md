# nvim-treesitter-queries-sparql

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-sparql/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-sparql/actions/workflows/validate.yml)

Neovim tree-sitter queries for **sparql**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-sparql",
...
- [ ] Changes are scoped to `sparql` — do not include files for other languages
